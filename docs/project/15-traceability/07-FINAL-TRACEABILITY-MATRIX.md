...
| S-008 | ADR-003, ADR-004, ADR-005, ADR-006, ADR-010 | 09-data-and-messaging/*, 07-interfaces-and-contracts/09-INTERNAL-EVENT-CONTRACTS.md | UC-016, UC-018 | US-011, US-016, US-018 | Soporta ST-001..ST-012 y EV-001..EV-019 | BDD-008, TDD-S-008, RES-TEST-001, RES-TEST-002, RES-TEST-003 |
| S-009 | ADR-001, ADR-004, ADR-005, ADR-006, ADR-008, ADR-010 | 03-target-architecture/07-OBSERVABILITY-ARCHITECTURE.md, 08-security/*, 13-operations/* | UC-001..UC-018 | Todas las historias implementadas | Transversal | TDD-S-009, SEC-TEST-001..SEC-TEST-004, RES-TEST-001..RES-TEST-004 |
...
- Los thresholds de `S-009` ya quedaron cuantificados y Fase 2 ya tiene evidencia Docker-first de runtime, pero todavia falta automatizar medicion end-to-end de observabilidad y thresholds sobre los servicios ejecutables.
- `TrayectoriaPaciente` queda implementado con query protegida, rebuild controlado y consola frontend, pero la migracion historica completa y el cambio de correlacion de sagas a `TrajectoryId` siguen pendientes de slices posteriores.
- El siguiente hueco material ya no es de codigo ejecutable base, sino de descubrimiento de trayectorias, contratos async machine-readable y validacion operativa mas amplia sobre los slices posteriores.
